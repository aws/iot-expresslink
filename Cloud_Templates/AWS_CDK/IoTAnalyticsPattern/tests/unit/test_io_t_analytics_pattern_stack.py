...
def test_wrong_format_channel_name(): 
    ...
    with pytest.raises(Exception, match=r"String format error for channel name: .*"):
        stack = IoTAnalyticsPatternStack(test_app, "io-t-analytics-pattern")
        template = assertions.Template.from_stack(stack)        
...
def test_wrong_length_channel_name(): 
    ...
    with pytest.raises(Exception, match=r".* The channel name must contain 1-128 characters."):
        stack = IoTAnalyticsPatternStack(test_app, "io-t-analytics-pattern")
        template = assertions.Template.from_stack(stack) 
...
def test_wrong_format_dataset_name(): 
    ...
    with pytest.raises(Exception, match=r"String format error for dataset name: .*"):
        stack = IoTAnalyticsPatternStack(test_app, "io-t-analytics-pattern")
        template = assertions.Template.from_stack(stack)        
...
def test_wrong_length_dataset_name(): 
    ...
    with pytest.raises(Exception, match=r".* The dataset name must contain 1-128 characters."):
        stack = IoTAnalyticsPatternStack(test_app, "io-t-analytics-pattern")
        template = assertions.Template.from_stack(stack)         
...
def test_wrong_format_datastore_name(): 
    ...
    with pytest.raises(Exception, match=r"String format error for datastore name: .*"):
        stack = IoTAnalyticsPatternStack(test_app, "io-t-analytics-pattern")
        template = assertions.Template.from_stack(stack) 
...
def test_wrong_format_pipeline_name(): 
    ...
    with pytest.raises(Exception, match=r"String format error for pipeline name: .*"):
        stack = IoTAnalyticsPatternStack(test_app, "io-t-analytics-pattern")
        template = assertions.Template.from_stack(stack)  
...
def test_wrong_format_role_name(): 
    ...
    with pytest.raises(Exception, match=r".* The IAM role name should be an alphanumeric string .*"):
        stack = IoTAnalyticsPatternStack(test_app, "io-t-analytics-pattern")
        template = assertions.Template.from_stack(stack)                 
...
def test_wrong_length_role_name(): 
    ...
    with pytest.raises(Exception, match=r"The length of the IAM role .*"):
        stack = IoTAnalyticsPatternStack(test_app, "io-t-analytics-pattern")
        template = assertions.Template.from_stack(stack)   
...
def test_wrong_format_rule_name(): 
    ...
    with pytest.raises(Exception, match=r".* The topic rule name should be an alphanumeric string .*"):
        stack = IoTAnalyticsPatternStack(test_app, "io-t-analytics-pattern")
        template = assertions.Template.from_stack(stack)                          